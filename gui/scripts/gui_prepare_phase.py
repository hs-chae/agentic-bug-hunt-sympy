...
def write_packet(
    *,
    ...
    lines = [
        ...
        "",
        "If validation reports `status: blocked`, fix only this phase's requested",
        "outputs or report the blocker, then rerun validation. Treat this as a",
        "soft block, not as a killed run.",
        "",
        "## Expected Outputs",
        "",
    ]
