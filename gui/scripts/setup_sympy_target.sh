...
Creates a reproducible SymPy target checkout/worktree for the GUI bug-hunt
pipeline.
...
Output:
  Prints TARGET_DIR=... as the final line. Use that path as --sympy-dir for the
  GUI bridge scripts, for example gui_prepare_phase.py.
